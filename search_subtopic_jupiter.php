...
<a class="active-menu" href="#"><i class="fa fa-desktop"></i>JUPITER<span class="fa arrow"></span></a>
        ...
        <div id="page-wrapper">
            ...
            <?php
                ...
                $url = 'http://api.nextexpertsacademymodules.great-site.net/api_learning/index.php/module_subtopic/search_subtopic_title/2/'.$g;//2 is arcording to the title id
                $ch = curl_init();
      ...
      <form  action="" method="GET">
        ...
        ?>
                    <div>
                    <a href="http://nextexpertsacademymodules.great-site.net/view_subtopic_jupiter.php?id=0?id=<?=$d['ms_id']?>"><?=$d['ms_title']?></a>
                    </div>
        <?php
                }
            }
