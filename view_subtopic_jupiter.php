...
<head>
    ...
    <title>LMS COURSE - JUPITER</title>
    <!-- Bootstrap Styles-->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <?php
                            ...
                            $url ='http://api.nextexpertsacademymodules.great-site.net/api_learning/index.php/module_subtopic/view_all_topic/2';//2 is jupiter
                            $ch = curl_init();
